...
console.log("(isOdd_1): Random number is: " + random.toString());

// ------------1st Try (Per Instructore Review)----------------

function isOdd_1 (numberToTest) {
	(numberToTest % 2 === 1) ? console.log("(isOdd_1): Number was odd.") : console.log("(isOdd_1): Number was even.");
}
...
function isOdd_4(number) {
		...
		(number % 2 == 1) ? console.log("(isOdd_4): Yeah, an Odd number:" + random) : console.log("(isOdd_4): Oops, an even number: " + random);
